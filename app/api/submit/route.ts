...
export async function POST(req: NextRequest) {
  ...
  const html = `
    ...
    <head>
      <meta charset="utf-8" />
      <style>
        body { font-family: 'Inter', Arial, sans-serif; background: #f4f6f9; margin: 0; padding: 40px 20px; }
        ...
        .header h1 { color: white; font-size: 20px; font-weight: 900; margin: 0 0 4px; letter-spacing: -0.5px; }
        .header p { color: #6b7280; font-size: 12px; letter-spacing: 0.1em; text-transform: uppercase; margin: 0; }
        .body { padding: 32px 36px; }
        .section-title { font-size: 10px; font-weight: 700; letter-spacing: 0.2em; text-transform: uppercase; color: #3B7B9C; margin: 24px 0 12px; }
    ...
    <body>
      <div class="card">
        ...
        <div class="body">
          ...
          <div class="field"><span class="label">Mileage</span><span class="value">${Number(miles).toLocaleString()} miles</span></div>
        ...
        <div class="footer">
          <p>This lead was submitted via the ${COMPANY} vehicle appraisal form.</p>
        </div>
      </div>
    </body>
    </html>
